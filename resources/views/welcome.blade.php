...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/landing_pages/css/vendor.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/landing_pages/style.css')}}">
  ...
  <body class="bg-body" data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
      ...
      <symbol xmlns="http://www.w3.org/2000/svg" id="quote" viewBox="0 0 8 8">
        <path fill="currentColor" d="M3 1C1.35 1 0 2.35 0 4v3h3V4H1c0-1.11.89-2 2-2V1zm5 0C6.35 1 5 2.35 5 4v3h3V4H6c0-1.11.89-2 2-2V1z" />
      </symbol>
        ...
        <div class="row g-md-5 align-items-center">
          ...
          <div class="col-lg-7 col-md-12">
            <div class="banner-content text-center p-5">
              <h1 class="display-1 text-center">Parfume Terbaik Seindonesia</h1>
      ...
      <div class="row">
        <div class="video-content open-up" data-aos="zoom-out">
          <div class="video-bg position-relative">
            <img src="{{asset('assets/landing_pages/images/video-item.jpg')}}" alt="video" class="img-fluid">
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 mb-5">
              <div class="product-card">
                <div class="image-holder position-relative zoom-effect">
                  <a href="#">
                    <img src="{{asset('assets/landing_pages/images/product-item1.jpg')}}" alt="product-item" class="img-fluid">
                  </a>
            ...
            <div class="col-lg-4 col-md-6 mb-5">
              <div class="product-card">
                <div class="image-holder position-relative zoom-effect">
                  <a href="#">
                    <img src="{{asset('assets/landing_pages/images/product-item2.jpg')}}" alt="product-item" class="img-fluid">
                  </a>
                  <div class="cart-concern position-absolute w-100 d-flex justify-content-center align-items-center">
                    <div class="cart-button position-absolute">
                      <button type="button" class="btn btn-dark text-uppercase" data-bs-toggle="modal" data-bs-target="#modallong"> add to cart </button>
            ...
            <div class="col-lg-4 col-md-6 mb-5">
              <div class="product-card">
                <div class="image-holder position-relative zoom-effect">
                  <a href="#">
                    <img src="{{asset('assets/landing_pages/images/product-item3.jpg')}}" alt="product-item" class="img-fluid">
                  </a>
                  <div class="cart-concern position-absolute w-100 d-flex justify-content-center align-items-center">
                    <div class="cart-button position-absolute">
                      <button type="button" class="btn btn-dark text-uppercase" data-bs-toggle="modal" data-bs-target="#modallong"> add to cart </button>
      ...
      <div class="container-lg">
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
            <div class="icon-box text-center">
              <div class="icon-box-icon mb-3">
                <svg class="balloon svg-secondary" width="39" height="39">
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 mb-4 border-start border-end">
            <div class="icon-box text-center">
              <div class="icon-box-icon mb-3">
                <svg class="bag-heart svg-secondary" width="39" height="39">
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
            <div class="icon-box text-center">
              <div class="icon-box-icon mb-3">
                <svg class="handiplast svg-secondary" width="39" height="39">
      ...
      <div class="container-lg">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 mb-3">
            <img src="{{asset('assets/landing_pages/images/insta-item1.jpg')}}" alt="instagram" class="img-fluid">
          </div>
          <div class="col-lg-2 col-md-6 mb-3">
            <img src="{{asset('assets/landing_pages/images/insta-item2.jpg')}}" alt="instagram" class="img-fluid">
          </div>
          <div class="col-lg-2 col-md-6 mb-3">
            <img src="{{asset('assets/landing_pages/images/insta-item3.jpg')}}" alt="instagram" class="img-fluid">
          </div>
          <div class="col-lg-2 col-md-6 mb-3">
            <img src="{{asset('assets/landing_pages/images/insta-item4.jpg')}}" alt="instagram" class="img-fluid">
          </div>
          <div class="col-lg-2 col-md-6 mb-3">
            <img src="{{asset('assets/landing_pages/images/insta-item5.jpg')}}" alt="instagram" class="img-fluid">
          </div>
          <div class="col-lg-2 col-md-6 mb-3">
            <img src="{{asset('assets/landing_pages/images/insta-item6.jpg')}}" alt="instagram" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="footer-bottom text-center py-3">
      <p>© 2024 BossQ Parfume
         
        </a>
      </p>
    </div>
    <script src="{{asset('assets/landing_pages/js/jquery.min.js')}}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/waypoints/4.0.1/jquery.waypoints.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/swiper@10/swiper-bundle.min.js"></script>
    <script src="{{asset('assets/landing_pages/js/plugins.js')}}"></script>
    <script src="{{asset('assets/landing_pages/js/script.js')}}"></script>
  </body>
</html>
