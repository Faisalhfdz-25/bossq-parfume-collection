        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active">Edit Landing Page</div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('landing_pages.update', $landingPage->id) }}" method="POST" enctype="multipart/form-data" id="landingPageForm">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group row">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Title</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title', $landingPage->title) }}">
                                            @error('title')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <div class="custom-file">
                                                ...
                                                <img id="banner_image_preview" src="{{ asset('storage/landing_page_images/' . $landingPage->banner_image_url) }}" alt="Banner Preview" class="img-fluid mt-3 mb-3" style="max-width: 50px;">
                                                @error('banner_image')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <div class="custom-file">
                                                ...
                                                <div id="instagram_photos_preview" class="img-fluid mt-3 mb-3" style="max-width: 50px;"></div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <div class="custom-file">
                                                ...
                                                <img id="single_photo_preview" src="{{ asset('storage/landing_page_images/' . $landingPage->single_photo_url) }}" alt="Single Photo Preview" class="img-fluid mt-3 mb-3" style="max-width: 50px;">
                                                @error('single_photo')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group mb-3 col-sm-12 col-md-7">
                                            ...
                                            <input type="text" class="form-control" name="product_price" value="{{ old('product_price', $landingPage->product_price) }}" aria-label="Amount (to the nearest dollar)">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <textarea class="summernote form-control @error('content') is-invalid @enderror" name="content">{{ old('content', $landingPage->content) }}</textarea>
                                            @error('content')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
